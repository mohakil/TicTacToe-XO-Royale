...
bool isTextScaleFactorAcceptable(BuildContext context) {
  final mediaQuery = MediaQuery.of(context);
  final textScaler = mediaQuery.textScaler;

  // Acceptable range: 0.8x to 2.0x
  return textScaler.scale(1) >= 0.8 && textScaler.scale(1) <= 2.0;
}

/// Get text scale factor status for debugging
String getTextScaleFactorStatus(BuildContext context) {
  final mediaQuery = MediaQuery.of(context);
  final textScaler = mediaQuery.textScaler;
