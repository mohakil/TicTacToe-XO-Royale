...
class _ComprehensiveVerificationWidgetState
  ...
  Future<void> _generateVerificationReport() async {
    ...
    try {
      ...
      final report = VerificationUtils.generateVerificationReport(
        context: context,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTestItem(
              ...
              VerificationUtils.verifyResponsiveBreakpoints(),
            ),
            ...
            _buildTestItem(
              ...
              _tapTargetSizes.asMap().entries.map((entry) {
                ...
                return VerificationUtils.verifyTapTargetSizeWithContext(
                  size,
            ...
            _buildTestItem(
              context,
              'Contrast Ratios',
              _foregroundColors.asMap().entries.expand((entry) {
                final index = entry.key;
                return VerificationUtils.verifyContrastRatios(
