...
class MarkPainter {
  ...
  static void _paintX(
    ...
    final shakeOffset = enableShake
        ? 2.0 * shakeValue * (shakeValue - 1.0)
        : 0.0;
    final shakenCenter = center.translate(shakeOffset, 0.0);
    ...
    if (animationValue > 0.5) {
      ...
      if (animationValue >= 1.0 && glowIntensity > 0.0) {
        ...
        canvas.drawLine(firstStart, firstEnd, glowPaint);
        canvas.drawLine(secondStart, secondEnd, glowPaint);
      }
    }
  }
