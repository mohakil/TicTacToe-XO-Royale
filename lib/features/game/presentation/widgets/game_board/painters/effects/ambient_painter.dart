...
class AmbientPainter {
  static const int _shapeCount = 6;
  ...
  static void paint(
    ...
    for (int i = 0; i < _shapeCount; i++) {
      final seed = i * 1000;
      final position = _getPosition(size, seed, animationValue);
  ...
  static Offset _getPosition(Size size, int seed, double animationValue) {
  ...
  static Color _getAmbientColor(int index) {
    final colors = [
