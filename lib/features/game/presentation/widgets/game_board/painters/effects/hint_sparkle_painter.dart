...
class HintSparklePainter {
  static const int _sparkleCount = 8;
  ...
  static void paint(
    ...
    for (int i = 0; i < _sparkleCount; i++) {
      final angle = (i / _sparkleCount) * 2 * pi;
      ...
      _drawSparkle(canvas, position, animationValue);
    }
